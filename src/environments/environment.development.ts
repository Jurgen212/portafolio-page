export const environment = {
    ...
    proyectos: [{
        ...
        description : 'Application with CRUD of users, login, password change, administrator registration and more. Developed together with Sebastian Dosman ( https://github.com/SebasDosman ) using angular and firebase. Currently working on the mobile version',
